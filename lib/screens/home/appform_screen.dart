        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: ListTile(
                title:
                    const Text('Sim', style: TextStyle(fontFamily: 'Ubuntu')),
                leading: Radio(
                  value: Awnswer.yes,
                  groupValue: _site,
            ...
            Padding(
              ...
              child: ListTile(
                title:
                    const Text('Não', style: TextStyle(fontFamily: 'Ubuntu')),
                leading: Radio(
                  value: Awnswer.no,
                  groupValue: _site,
                  onChanged: (Awnswer value) {
            ...
            Padding(
              ...
              child: ListTile(
                title:
                    const Text('Mau', style: TextStyle(fontFamily: 'Ubuntu')),
                leading: Radio(
                  value: Swim.m,
                  groupValue: _sl,
                  onChanged: (Swim value) {
            ...
            Padding(
              ...
              child: ListTile(
                title:
                    const Text('Bom', style: TextStyle(fontFamily: 'Ubuntu')),
                leading: Radio(
                  value: Swim.b,
                  groupValue: _sl,
                  onChanged: (Swim value) {
